...
%With this approach we estimated about 2000 CNFET for implementing that blocks when
%it is implemented in a network with $100\times100$ nodes. 
%This number of resource can be certainly reducing 
