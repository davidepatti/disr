...
reaching the same goals of a segment based turn prohibition  without
requiring any topology graph or centralized execution.  In particular
\disr{} aims to obtain a segment network partitioning using a
completely different mechanism, based on a distributed exchange of
small setup packets. The following main features distinguish \disr{}
