...
(link from $9$, node $8$, link, node $7$, link, node $6$, link, node $5$, link to the $1$). Note
...
strictly related to the general question: which level of
parallelism should we allow in \disr{}? The adopted approach is that, although
