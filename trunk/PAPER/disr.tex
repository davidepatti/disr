...
\subsection{DiSR Execution Model}
...
\begin{figure}
  \centering
    \includegraphics[width=0.40\textwidth]{pictures/dbs_updated.eps}
...
%Each of the subsequent nodes will forward this \texttt{SEGMENT\_CANCEL}
...
% TODO: FIX and RE-enable in long paper
